...
export const socialPlatforms: SocialPlatform[] = [
  ...
  { name: "LinkedIn", description: "Professional profile and work experience", metric: "in", metricLabel: "Connect", url: "https://www.linkedin.com/in/ahmed-a-14050a383", icon: "Linkedin", color: "#0A66C2" },
